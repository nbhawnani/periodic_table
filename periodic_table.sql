...
--
-- Name: type_id; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--
...
ALTER TABLE public.type_id OWNER TO freecodecamp;
...
CREATE TABLE public.types (
    type_id integer DEFAULT nextval('public.type_id'::regclass) NOT NULL,
...
--
-- Name: type_id; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.type_id', 3, true);
